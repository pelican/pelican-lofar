...
//        }
    ...
    private:
        ...
        /// Time block index.
        unsigned long _tbIndex(unsigned s, unsigned p, unsigned tb) const;
...
template <typename T>
inline unsigned long TimeSeriesDataSet<T>::_tbIndex(unsigned s, unsigned p,
        unsigned tb) const
{
