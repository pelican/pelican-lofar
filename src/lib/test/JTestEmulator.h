#ifndef JTESTEMULATOR_H
#define JTESTEMULATOR_H
 ...
 * </JTestEmulator>
 */
class JTestEmulator : public AbstractUdpEmulator
{
    public:
        // Constructs a new UDP packet emulator.
        JTestEmulator(const ConfigNode& configNode);
