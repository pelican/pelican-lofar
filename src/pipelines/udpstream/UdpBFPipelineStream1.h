#ifndef UDP_BF_PIPELINE_STREAM1_H
#define UDP_BF_PIPELINE_STREAM1_H
 ...
 *
 */
class UdpBFPipelineStream1 : public AbstractPipeline
{
    public:
        UdpBFPipelineStream1();
        ~UdpBFPipelineStream1();
...
#endif // UDP_BF_PIPELINE_STREAM1_H
