#ifndef UDP_BF_PIPELINE_STREAM2_H
#define UDP_BF_PIPELINE_STREAM2_H
 ...
 *
 */
class UdpBFPipelineStream2 : public AbstractPipeline
{
    public:
        UdpBFPipelineStream2();
        ~UdpBFPipelineStream2();
...
#endif // UDP_BF_PIPELINE_STREAM2_H
